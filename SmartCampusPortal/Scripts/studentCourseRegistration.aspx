        ...
        <div class="container-fluid">
            <div class="row">
                <nav class="col-md-2 d-none d-md-block sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="studentCourseRegistration.aspx">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 content">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <asp:GridView ID="gvAvailableCourses" runat="server" AutoGenerateColumns="False" DataKeyNames="CourseID"
                                CssClass="table" HeaderStyle-CssClass="thead-custom" OnRowCommand="gvAvailableCourses_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="CourseID" HeaderText="ID" ReadOnly="True" />
                                    <asp:BoundField DataField="CourseName" HeaderText="Course Name" />
                                    <asp:BoundField DataField="Department" HeaderText="Department" />
                                    <asp:BoundField DataField="Credits" HeaderText="Credits" />
                                    <asp:BoundField DataField="PrerequisiteCourseName" HeaderText="Prerequisite" />
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:Button ID="btnRegister" runat="server" CommandName="RegisterCourse" CommandArgument='<%# Eval("CourseID") %>' Text="Register" CssClass="btn btn-sm btn-primary" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-registered"></i> Your Registered Courses
                        </div>
                        <div class="card-body">
                            <asp:GridView ID="gvRegisteredCourses" runat="server" AutoGenerateColumns="False" DataKeyNames="RegistrationID"
                                CssClass="table" HeaderStyle-CssClass="thead-custom" OnRowDeleting="gvRegisteredCourses_RowDeleting">
                                <Columns>
                                    <asp:BoundField DataField="CourseName" HeaderText="Course Name" />
                                    <asp:BoundField DataField="Department" HeaderText="Department" />
                                    <asp:BoundField DataField="Credits" HeaderText="Credits" />
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnDrop" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-danger">
