                ...
                <nav class="col-md-2 d-none d-md-block sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="facultyViewAttendance.aspx">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 content">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-filter"></i> Filter Attendance by Course
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="ddlStatusFilter"><i class="fas fa-info-circle"></i> Status</label>
                            ...
                            <asp:Button ID="btnFilterAttendance" runat="server" Text="Apply Filter" CssClass="btn btn-primary" OnClick="btnFilterAttendance_Click" />
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 content">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-edit"></i> Mark New Attendance
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="ddlMarkAttendanceCourse"><i class="fas fa-book-reader"></i> Select Course to Mark Attendance</label>
                                <asp:DropDownList ID="ddlMarkAttendanceCourse" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlMarkAttendanceCourse_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label for="txtMarkAttendanceDate"><i class="fas fa-calendar-plus"></i> Select Date to Mark Attendance</label>
                                <asp:TextBox ID="txtMarkAttendanceDate" runat="server" TextMode="Date" CssClass="form-control" AutoPostBack="True" OnTextChanged="txtMarkAttendanceDate_TextChanged"></asp:TextBox>
                            </div>
                            <asp:Panel ID="pnlMarkAttendance" runat="server" Visible="false">
                                <hr />
                                    ...
                                    <asp:GridView ID="gvMarkAttendance" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Attendance Status">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlAttendanceStatus" runat="server" CssClass="form-control form-control-sm">
                                                        <asp:ListItem Text="Present" Value="Present"></asp:ListItem>
                                                        <asp:ListItem Text="Absent" Value="Absent"></asp:ListItem>
                                                        <asp:ListItem Text="Late" Value="Late"></asp:ListItem>
                                                    </asp:DropDownList>
                                ...
                                <asp:Button ID="btnSaveAttendance" runat="server" Text="Save Attendance" CssClass="btn btn-success mt-3" OnClick="btnSaveAttendance_Click" />
                            </asp:Panel>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-filter"></i> Filter Existing Attendance Records
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="ddlCourseFilter"><i class="fas fa-book-open"></i> Select Course</label>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="fas fa-clipboard-list"></i> Existing Attendance Records
                        </div>
                        <div class="card-body">
                            <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False"
                                CssClass="table" HeaderStyle-CssClass="thead-custom">
                                <Columns>
                                    <asp:BoundField DataField="FullName" HeaderText="Student Name" />
                                    <asp:BoundField DataField="CourseName" HeaderText="Course" /> <%-- Added Course Name --%>
                                    <asp:BoundField DataField="Date" HeaderText="Date" DataFormatString="{0:d}" />
                                    <asp:BoundField DataField="Status" HeaderText="Status" />
                                </Columns>
                                <HeaderStyle CssClass="thead-custom" />
