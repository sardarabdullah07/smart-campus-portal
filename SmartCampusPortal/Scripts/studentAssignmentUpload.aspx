                ...
                <nav class="col-md-2 d-none d-md-block sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="studentAssignmentUpload.aspx">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlAssignment" runat="server" CssClass="form-control"></asp:DropDownList>
                            </div>

                            <div class="form-group">
                                <label for="fileUploadAssignment"><i class="fas fa-paperclip"></i> Upload File</label>
                                <asp:FileUpload ID="fileUploadAssignment" runat="server" CssClass="form-control-file" />
                                <small class="form-text">Max file size: 5MB. Allowed types: .pdf, .doc, .docx, .txt, .zip, .rar.</small>
                            </div>

                            <div class="form-group">
                                <label for="txtComment"><i class="fas fa-comment-dots"></i> Comments (Optional)</label>
                                <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control"></asp:TextBox>
                            </div>

                            <asp:Button ID="btnUpload" runat="server" Text="Upload Assignment" CssClass="btn btn-primary mt-3" OnClick="btnUpload_Click" />
                        </div>
                    </div>
